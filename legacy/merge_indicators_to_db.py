#!/usr/bin/env python3
"""
지표별 분산된 YAML 파일들을 데이터베이스로 통합하는 스크립트

각     def merge_trading_variables(self, conn: sqlite3.Connection, data: Dict[str, Any],
                                category: str, indicator: str, dry_run: bool = False):의 5개 파일(definition.yaml, parameters.yaml, help_texts.yaml, placeholders.yaml, help_guide.yaml)을
읽어서 SQLite 데이터베이스 테이블들에 통합합니다.
