...
class CandleCollectionTester:
    ...
    async def __aenter__(self):
        """비동기 컨텍스트 매니저 진입"""
        self.provider = await create_candle_data_provider_async()
        return self
    ...
    async def collect_and_analyze(
        ...
        provider_stats_before = self.provider.get_stats()
        ...
        provider_stats_after = self.provider.get_stats()
        ...
        stats = CollectionStats(
            ...
            # Provider 통계 변화
            api_requests_made=provider_stats_after['api_requests'] - provider_stats_before['api_requests'],
            chunks_processed=provider_stats_after['chunks_processed'] - provider_stats_before['chunks_processed'],
            cache_hits=provider_stats_after['cache_hits'] - provider_stats_before['cache_hits'],
            mixed_optimizations=provider_stats_after.get('mixed_optimizations', 0) - provider_stats_before.get('mixed_optimizations', 0),
