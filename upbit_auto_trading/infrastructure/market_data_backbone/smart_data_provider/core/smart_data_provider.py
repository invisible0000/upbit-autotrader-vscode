...
from .realtime_data_handler import RealtimeDataHandler
...
class SmartDataProvider:
    ...
    def __init__(self,
        ...
        # 실시간 데이터 처리기 (Phase 4.0 - 기능 분할)
        self.realtime_handler = RealtimeDataHandler(
    ...
    async def get_ticker(self,
        ...
        Returns:
            DataResponse 객체
        """
        return await self.realtime_handler.get_ticker(symbol, priority)

    async def get_tickers(self,
                          symbols: List[str],
                          priority: Priority = Priority.HIGH) -> DataResponse:
        """
        다중 심볼 티커 조회 (실시간 데이터 처리기로 위임)
        ...
        Returns:
            DataResponse 객체
        """
        return await self.realtime_handler.get_tickers(symbols, priority)

    async def get_orderbook(self,
                            symbol: str,
                            priority: Priority = Priority.HIGH) -> DataResponse:
        """
        호가창 조회 (실시간 데이터 처리기로 위임)
        ...
        Returns:
            DataResponse 객체
        """
        return await self.realtime_handler.get_orderbook(symbol, priority)
    ...
    async def get_trades(self,
        ...
        Returns:
            DataResponse 객체
        """
        return await self.realtime_handler.get_trades(symbol, count, priority)
    ...
    async def get_continuous_candles(
        ...
        Returns:
            연속된 캔들 데이터 응답
        """
        from upbit_auto_trading.infrastructure.market_data_backbone.smart_data_provider.processing.collection_status_manager import (  # noqa: E501
    ...
    async def get_markets(self,
        ...
        try:
            ...
            # 직접 UpbitPublicClient 사용 (async context manager로 세션 정리)
