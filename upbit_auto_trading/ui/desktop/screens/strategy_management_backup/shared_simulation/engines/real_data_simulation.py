...
try:
    ...
    logger = create_component_logger("RealDataSimulation")
except ImportError:
    import logging
    logger = logging.getLogger("RealDataSimulation")

# 전역 DB 매니저 비활성화 - DDD Infrastructure Layer 사용
USE_GLOBAL_MANAGER = False
logger.info("전역 DB 매니저 비활성화 - DDD Infrastructure Layer 패턴 사용")
